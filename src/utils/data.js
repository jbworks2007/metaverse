...
import { BsHeadset, BsBuilding, BsShop } from 'react-icons/bs';
...
const AnyverseLinks = [
  {
    ...
    icon: <BsBuilding />,
    href: "metaverse-real-estate",
  },
  {
    title: "Metaverse for E-Commerce",
    icon: <BsShop />,
    href: "metaverse-ecommerce",
  },
  {
    title: "Metaverse for Travel & Tourism",
    icon: <BiTrain />,
    href: "metaverse-travel-tourism",
  },
  {
    title: "Metaverse for Banking",
    icon: <BiDollarCircle />,
    href: "metaverse-banking",
  },
  {
    title: "Metaverse-Corporate Branding",
    icon: <MdCorporateFare />,
    href: "metaverse-corporate-branding",
  },
  {
    title: "Metaverse-Government & NGOs",
    icon: <MdCorporateFare />,
    href: "metaverse-gov-np",
  }
];
...
const registerTestimonial = [
  ...
  },
  {
    ...
    header: 'Amazing Anyverse template!',
